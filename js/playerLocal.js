...
function KuwoUrl(id, callback) {
    var mp3Url = 'http://192.168.1.249:7878/kuwo/' + id + '.mp3';
...
function play(music) {
    ...
    if (music.url.includes('/kw/')) {
        ...
        var mp3Url = `http://192.168.1.249:7878/kuwo/${music.url_id}.mp3`;
        try {
            rem.audio[0].pause();
            rem.audio.attr('src', mp3Url);
            rem.audio[0].play();
        ...
        //     }
        // })
        var mp3Url = `http://192.168.1.249:7878/netease/${music.id}.mp3`;
        try {
            rem.audio[0].pause();
            rem.audio.attr('src', mp3Url);
            rem.audio[0].play();
